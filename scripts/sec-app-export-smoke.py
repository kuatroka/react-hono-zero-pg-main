...
sys.path.insert(0, "/Users/yo_macbook/Documents/dev/sec_app/src")

from sec_app.pipeline.db_creation_utils import export_duckdb_tables_to_postgres  # noqa: E402
...
if not duckdb_path.exists():
    raise FileNotFoundError(f"DuckDB source not found: {duckdb_path}")
